...
urlpatterns = [
    ...
    path('filter_tree?base=<str:base>/', FilterTreeView_v1, name='filter_tree'),
    path('filter_results?base=<str:base>&filters=<str:filters>/', FilterResultsView_v1, name='filter_results'),
]
