    ...
    <div className="container my-5">
      <div className="row">
            ...
            <div className="card-body">
              ...
              <div className="d-flex align-items-start mb-3">
                <Link to="/database" className="icon-links me-3 align-self-center">
                  <img src="/assets/images/database.png" alt="database" className="database-icon mb-3" width="40" height="40" />
                </Link>
                <div>
              ...
              <div className="d-flex align-items-start">
                <Link to="/change-log" className="icon-links me-3 align-self-center">
                  <img src="/assets/images/scroll.png" alt="change log" className="database-icon mb-3" width="40" height="40" />
                </Link>
                <div>
        ...
        <div className="col-lg-6">
          <div className="card mb-4 border-0 rounded-4 shadow">
            <div className="card-body">
              <small className="text-muted">Awaiting Your Action</small><br /><br />
              {awaitingActions.map(a => (
                <div key={a.id} className="d-flex align-items-start mb-3">
          ...
          <div className="card mb-4 border-0 rounded-4 shadow">
            <div className="card-body">
              <small className="text-muted">Things In Progress</small><br /><br />
              {inProgress.map(item => (
        ...
        <div className="col-lg-6">
          <div className="card mb-4 border-0 rounded-4 shadow">
            <div className="card-body">
              <small className="text-muted">Upcoming Dates</small><br /><br />
          ...
          <div className="card mb-4 border-0 rounded-4 shadow">
            <div className="card-body">
              <small className="text-muted">Recent Actions</small><br /><br />
              <ul>
